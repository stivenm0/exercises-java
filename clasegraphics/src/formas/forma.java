...
public class forma extends javax.swing.JFrame {
    ...
    public void paint(Graphics g) {
        ...
        g.drawRect(150, 100, 70, 70);
        g.drawRoundRect(250, 100, 70, 70, 10, 10);
      ...
      int vectory[]={70,120,120};
        ...
        g.fillRect(150, 200, 70, 70);
        g.fillRoundRect(250, 200, 70, 70, 10, 10);
        g.fillOval(350, 200, 80, 80);
        
       int vectorX[]= {500,550,450};
      int vectorY[]={220,260,260};
